      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto px-4 lg:px-8 py-6 space-y-6">
          <div>
            ...
            <p className="text-text-secondary text-sm mt-1">Financial overview based on your transactions</p>
          </div>
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <div className="flex items-center gap-4 text-xs text-text-secondary">
                      <span className="flex items-center gap-1.5">
                        <span className="w-2.5 h-2.5 rounded-sm bg-primary/70 inline-block" />Income
                      </span>
                      <span className="flex items-center gap-1.5">
                        <span className="w-2.5 h-2.5 rounded-sm bg-blue-500/60 inline-block" />Expenses
                      </span>
                    </div>
                  </div>
